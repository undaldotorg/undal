...
class TransactionTimeRescanTest(UndalTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine UBTC and create transactions
        ...
        # generate some ubtc to create transactions and check blockcount
        ...
        # send 10 ubtc to user's first watch-only address
        self.log.info('Send 10 ubtc to user')
        ...
        # send 5 ubtc to our second watch-only address
        self.log.info('Send 5 ubtc to user')
        ...
        # send 1 ubtc to our third watch-only address
        self.log.info('Send 1 ubtc to user')
