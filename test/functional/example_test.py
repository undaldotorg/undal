...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the UndalTestFramework
    pass


class ExampleTest(UndalTestFramework):
    # Each functional test is a subclass of the UndalTestFramework class.
    ...
    def custom_method(self):
        ...
        UndalTestFramework class so other tests can use it."""
