...
By default, undald will dump mempool on shutdown and
...
class MempoolPersistTest(UndalTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent undald from writing mempool.dat to disk. Verify that `savemempool` fails")
