...
"""Verify that starting undal with -h works as expected."""

from test_framework.test_framework import UndalTestFramework
from test_framework.util import assert_equal

class HelpTest(UndalTestFramework):
    ...
    def run_test(self):
        self.log.info("Start undal with -h for help text")
        ...
        self.log.info("Start undal with -version for version information")
        ...
        self.log.info("Start undald with -fakearg to make sure it does not start")
