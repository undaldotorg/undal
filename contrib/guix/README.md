# Bootstrappable Undal Core Builds

This directory contains the files necessary to perform bootstrappable Undal
Core builds.
...
To build Undal Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Undal Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/undal-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/undal-core/guix.sigs).
