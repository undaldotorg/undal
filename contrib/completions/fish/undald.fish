...
complete --command undald --no-files

# Extract options
function __fish_undald_get_options
...
complete \
    --command undald \
    --arguments "(__fish_undald_get_options --nofiles)"
