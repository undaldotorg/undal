...
# Extract options
function __fish_undal_tx_get_options
...
# Extract commands
function __fish_undal_tx_get_commands
...
complete \
    --command undal-tx \
    --condition "not __fish_undal_seen_cmd (__fish_undal_tx_get_commands --commandsonly)" \
    --arguments "(__fish_undal_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command undal-tx \
    --arguments "(__fish_undal_tx_get_commands)" \
    --no-files
