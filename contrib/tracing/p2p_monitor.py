...
""" Interactive undald P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Undal Core can enable. It uses BCC
...
def main(undald_path):
    ...
    undald_with_usdts.enable_probe(
