...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef UNDAL_CHAINPARAMSSEEDS_H\n')
    g.write('#define UNDAL_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the undal network\n')
    ...
    g.write('#endif // UNDAL_CHAINPARAMSSEEDS_H\n')
