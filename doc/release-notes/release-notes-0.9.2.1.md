Undal Core version 0.9.2.1 is now available from:

  https://undal.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 UBTC to 0.01 UBTC
...
- Fix "Start undal on system login"
