Undal Core version 0.10.4 is now available from:

  <https://undal.org/bin/undal-core-0.10.4/>
...
- #6953 `43c2789` Split undal-tx into its own package
- #6953 `dfe0d4d` Include undal-tx binary on Debian/Ubuntu
