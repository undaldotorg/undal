Download URL: https://sourceforge.net/projects/undal/files/Undal/undal-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 UBTC fee schedule (users still pay 0.01 UBTC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #undal00 - #undal99
