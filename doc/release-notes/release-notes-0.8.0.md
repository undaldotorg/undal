Undal-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/undal/files/Undal/undal-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Undal
...
New/changed settings (command-line or undal.conf file)
--------------------------------------------------------
