Undal Core version 0.9.4 is now available from:

  https://undal.org/bin/0.9.4/
...
this update is incompatible with the Undal system and could lead to consensus
forks.

Undal Core released binaries from https://undal.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~undal/+archive/ubuntu/undal
- A third-party or self-compiled Undal Core

upgrade to Undal Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
