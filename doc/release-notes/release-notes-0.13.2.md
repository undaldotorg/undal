Undal Core version 0.13.2 is now available from:

  <https://undal.org/bin/undal-core-0.13.2/>
...
- #8908 `4a974b2` Update undal-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow undal-tx to create v2 transactions (ubtcdrak)
