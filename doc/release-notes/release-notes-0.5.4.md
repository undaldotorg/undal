Undal version 0.5.4 is now available for download at:
http://sourceforge.net/projects/undal/files/Undal/undal-0.5.4/
...
http://gitorious.org/undal/undald-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Undal-Qt notifications under Growl 1.3.
Increase required age of Undal-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxUndal properly when installing Undal-Qt over it. (Windows)
