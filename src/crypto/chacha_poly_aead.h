...
#ifndef UNDAL_CRYPTO_CHACHA_POLY_AEAD_H
#define UNDAL_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@undal.
 *
 ...
 *
 * The chacha20-poly1305@undal combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@undal cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@undal are relatively fast in
...
#endif // UNDAL_CRYPTO_CHACHA_POLY_AEAD_H
