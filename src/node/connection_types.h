...
#ifndef UNDAL_NODE_CONNECTION_TYPES_H
#define UNDAL_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/undal-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Undal’s Peer-to-Peer Network")
...
#endif // UNDAL_NODE_CONNECTION_TYPES_H
