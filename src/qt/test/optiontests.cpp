...
{
    // Test regression https://github.com/undal/undal/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/undal-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/undal-core/gui/pull/568.
    // With fListen=false in ~/.config/Undal/Undal-Qt.conf and all else left as default,
    // undal-qt should set both -listen and -listenonion to false and start successfully.
