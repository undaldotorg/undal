...
#ifndef UNDAL_QT_GUIUTIL_H
#define UNDAL_QT_GUIUTIL_H
...
/** Utility functions used by the Undal Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "undal:" URI into recipient object, return true on successful parsing
