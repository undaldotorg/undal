...
#ifndef UNDAL_QT_UNDALUNITS_H
#define UNDAL_QT_UNDALUNITS_H
...
/** Undal unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class UndalUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit UndalUnits(QObject *parent);

    /** Undal units.
      @note Source: https://en.undal.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        UBTC,
        mUBTC,
