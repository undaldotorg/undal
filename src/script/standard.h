...
#ifndef UNDAL_SCRIPT_STANDARD_H
#define UNDAL_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a undal address
 */
...
/**
 * Generate a Undal scriptPubKey for the given CTxDestination. Returns a P2PKH
