...
#ifndef UNDAL_INTERFACES_NODE_H
#define UNDAL_INTERFACES_NODE_H
...
//! Top-level interface for a undal node (undald process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or undal.conf.
