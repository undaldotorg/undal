...
#ifndef UNDAL_WALLET_TRANSACTION_H
#define UNDAL_WALLET_TRANSACTION_H
...
public:
     ...
     * on this undal node, and set to 0 for transactions that were created
...
#endif // UNDAL_WALLET_TRANSACTION_H
