...
#ifndef UNDAL_WALLET_SCRIPTPUBKEYMAN_H
#define UNDAL_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Undal Core wallet was originally a collection of unrelated private
...
#endif // UNDAL_WALLET_SCRIPTPUBKEYMAN_H
