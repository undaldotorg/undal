...
#ifndef UNDAL_UTIL_SYSCALL_SANDBOX_H
#define UNDAL_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during undald initialization if Undal Core was compiled
...
#endif // UNDAL_UTIL_SYSCALL_SANDBOX_H
