 ...
 */
#ifndef UNDAL_UTIL_SYSTEM_H
#define UNDAL_UTIL_SYSTEM_H
...
extern const char * const UNDAL_CONF_FILENAME;
extern const char * const UNDAL_SETTINGS_FILENAME;
