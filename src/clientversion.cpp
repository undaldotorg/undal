 ...
 * for both undald and undal-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Undal");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/undal/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/undal/undal>";
